...
<div class="container cont">
    <form method="post" action="#" enctype="multipart/form-data">
        <div class="form-group col-md-offset-1 col-md-10">
            ...
            <input type="text" class="form-control" id="title" name="title" value="<?= $v['name_offer']; ?>">
        </div>
        <div class="form-group col-md-offset-1 col-md-10">
            <label for="desc">Description</label>
            <input type="text" class="form-control" id="desc" name="desc" value="<?= $v['description']; ?>">
        </div>
        <div class="form-group col-md-offset-1 col-md-2">
            <label for="ville">Ville</label>
            <input type="text" class="form-control" id="ville" name="city" value="<?= $v['city_offer']; ?>">
        </div>
        <div class="form-group col-md-6">
            <label for="adresse">Lieux de rencontre</label>
            <input type="text" class="form-control" id="adresse" name="adr" value="<?= $v['place_offer']; ?>">
        </div>
        ...
        <div class="form-group col-md-offset-1 col-md-10">
            ...
            <input type="text" class="form-control" id="dsp" name="dsp" value="<?= $v['postal_code_offer']; ?>">
        </div>
        <div class="form-group col-md-offset-1 col-md-10">
