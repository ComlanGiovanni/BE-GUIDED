...
if (!empty($_POST)) {
    App::getUser()->guide($db, $_POST['city'], $_POST['cdp'], $_POST['address'], $_POST['numTel'], $_POST['inter'], $_POST['langue'], $_POST['other']);
}
?>
<!DOCTYPE html>
<html lang="">
    ...
    <form action="#" method="post">
        <div class="form-group col-sm-6">
            ...
            <div class="form-group col-md-12">
                <div class="form-group col-sm-6">
                    <input type="tel" pattern="[0-9]{10}" title="Exemple: 0701020304" class="form-control" id="numTel"
                           name="numTel" placeholder="Mobile">
                </div>
                <div class="form-group col-sm-6">
            ...
            <div class="form-group col-md-12">
                <div class="form-group col-sm-6">
                    <input type="text" pattern="[0-9]{5}" name="cdp" id="cdp" class="form-control"
                           title="Exemple: 75000" placeholder="Code Postal">
                </div>
                <div class="form-group col-sm-6">
        ...
        <div class="form-group col-sm-6 details">
            ...
            <div class="form-group col-md-12">
                <div class="form-group col-sm-6">
                    <input type="text" class="form-control" name="other" placeholder="Expérience">
                </div>
                <div class="form-group col-sm-6">
