    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand page-scroll" href="#page-top">
                <span><img src="img/lg.png" width="50px" height="40" style="margin: -12px 0px 0px 0px" alt=""><span
                            class="light">Guide </span> <span style="color:red;">ME</span> !</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a class="page-scroll" href="connexion.html#signup"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Inscription</a>
                </li>
                <li>
                    <a class="page-scroll" href="connexion.html#login"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span> Connexion</a>
                </li>
                <li>
